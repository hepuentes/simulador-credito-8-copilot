...
if st.button("Simular"):
    ...
    # Botón de WhatsApp
    st.markdown("""
    <h3 style='text-align: center;'>¿Interesado en solicitar este crédito?</h3>
    <p style='text-align: center;'>Para más información, comuníquese con nosotros por WhatsApp:</p>
    <p style='text-align: center;'><a href='https://wa.me/XXXXXXXXXXX' target='_blank' class='whatsapp-link'>Hacer solicitud vía WhatsApp</a></p>
    """, unsafe_allow_html=True)
